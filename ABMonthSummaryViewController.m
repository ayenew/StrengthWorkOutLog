//
//  ABMonthSummaryViewController.m
//  StrengthWorkoutLog
//
...
#import "ABMonthSummaryViewController.h"
#import "ABAppDelegate.h"
#import "ExerciseLog.h"
#import "ABDateUtility.h"

@interface ABMonthSummaryViewController (){
...
@implementation ABMonthSummaryViewController
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"date >= %@ and date <=%@",
                              [ABDateUtility monthStartDate:[NSDate date]], [NSDate date]] ;
	...
	NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"exerciseName" ascending:NO];
